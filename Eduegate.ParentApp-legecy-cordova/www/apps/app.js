...
app.config(function ($stateProvider, $urlRouterProvider, $httpProvider) {
  ...
  .state('signupdashboard', {
    url: "/signupdashboard",
    templateUrl: "partials/signupdashboard.html",
    controller: 'SignupDashboardController'
  })

  .state('eventdetails', {
    url: "/eventdetails:SignupGroupID",
  ...
  .state('meetingrequestlist', {
    url: "/meetingrequestlist",
    templateUrl: "partials/meetingRequestList.html",
    controller: 'MeetingRequestListController',
  })
  .state('meetingrequest', {
    url: "/meetingrequest",
    templateUrl: "partials/meetingRequest.html",
  ...
  .state('communicationsdashboard', {
    url: "/communicationsdashboard",
    templateUrl: "partials/communicationsdashboard.html",
  ...
  .state('message', {
    url: "/message:RecieverID?RecieverEmail?EmployeeName?StudentID?StudentName?AdmissionNumber",
  ...
  .state('meetingremarks', {
    url: "/meetingremarks",
    templateUrl: "partials/meetingremarks.html",
    controller: 'MeetingRemarksController',
  })

  .state('meetingaccount', {
    url: "/meetingaccount",
    templateUrl: "partials/meetingaccount.html",
    controller: 'MeetingAccountController',
  })

  .state('generatetickets', {
    url: "/generatetickets",
    templateUrl: "partials/generatetickets.html",
    controller: 'GenerateTicketsController'
  })
  ...
  .state('counselorhub', {
    url: "/counselorhub",
    templateUrl: "partials/counselorhub.html",
    controller: 'CounselorHubController'
  })
  .state('studenttransportrequestlist', {
    url: "/studenttransportrequestlist",
    templateUrl: "partials/studenttransportrequestlist.html",
    controller: 'StudentTransportRequestListController',
 
  })

  .state('studenttransportrequestapplication', {
    url: "/studenttransportrequestapplication:TransportApplctnStudentMapIID",
    templateUrl: "partials/studenttransportrequestapplication.html",
    controller: 'StudentTransportRequestController',
       params: {
      TransportApplctnStudentMapIID: null,
    }
  })
