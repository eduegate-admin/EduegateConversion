app.controller('SuperAdminDashboardController', ['$scope', '$http', 'loggedIn', 'rootUrl',
    '$location', 'GetContext', '$state', '$stateParams', '$sce', '$rootScope', '$q', 'clientSettings', '$timeout',
    function ($scope, $http, loggedIn, rootUrl, $location, GetContext, $state, $stateParams, $sce, $rootScope,
        $q , clientSettings , $timeout) {
  ...
  $scope.ScanQRCode = function () {
          ...
          function (result) {
            ...
            if (result) {
              $scope.$apply(function () {
                ...
                GetDetailsByQRCode($scope.QRCodeValue);
    ...
    //GetDetailsByQRCode("Cx9QZk0olmLIFv1ShUWJT6978TRyfGa0oSU2D0dGGL3iEMPeP0WKn1pjET4zbM3r");
    //GetDetailsByQRCode("mwJJjJvNku2TbhYC7mCETWq2nitNwqYM6XlwSDYA5eY=");
    //GetDetailsByQRCode("P0118");
  };

  function GetDetailsByQRCode(QrCode) {
  ...
  $scope.submitLog = function (status) {
