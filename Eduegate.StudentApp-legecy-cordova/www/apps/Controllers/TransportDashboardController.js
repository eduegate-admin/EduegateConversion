app.controller('TransportDashboardController', ['$scope', '$http', 'loggedIn', 'rootUrl', '$location', 'GetContext', 'serviceCartCount', '$state', '$stateParams', '$sce', '$rootScope','serviceAddToCart', function ($scope, $http, loggedIn, rootUrl, $location, GetContext, serviceCartCount, $state, $stateParams, $sce, $rootScope, serviceAddToCart) {
    ...
    $scope.GetSettingValues = function () {
        $http({
            method: 'GET',
            url: appDataUrl + '/GetSettingValueByKey?settingKey=' + 'CLIENT_APPSTORELINK',
            headers: {
        ...
        $http({
            method: 'GET',
            url: appDataUrl + '/GetSettingValueByKey?settingKey=' + 'CLIENT_PLAYSTORELINK',
            headers: {
                "Accept": "application/json;charset=UTF-8",
                "Content-type": "application/json; charset=utf-8",
                "CallContext": JSON.stringify(context)
