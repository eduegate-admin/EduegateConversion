app.controller('AllergiesController', ['$scope', '$http', 'loggedIn', 'rootUrl', '$location', 'GetContext', 'serviceCartCount', '$state', '$stateParams', '$sce', '$rootScope', function ($scope, $http, loggedIn, rootUrl, $location, GetContext, serviceCartCount, $state, $stateParams, $sce, $rootScope) {
        ...
        $scope.SaveAllergies = function(events, StudentID, modelAllergies) {
            ...
            $http({
                url: dataService + "/SaveAllergies?studentID=" + StudentID + "&allergyID=" + modelAllergies,
                method: 'POST',
