app.controller('LiveRevenueDashboardController', ['$scope', '$http', 'loggedIn', 'rootUrl', '$location', 'GetContext', '$state', '$stateParams', '$sce', '$rootScope', function ($scope, $http, loggedIn, rootUrl, $location, GetContext, $state, $stateParams, $sce, $rootScope) {
  ...
  $scope.getPageInfo = function () {
    ...
    pageInfoPromise = $http({
      url: rootUrl + '/GetPageInfo?pageID=119&parameter=',
      method: 'GET',
