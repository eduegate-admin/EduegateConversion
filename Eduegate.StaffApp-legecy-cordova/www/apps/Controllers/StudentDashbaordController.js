app.controller('StudentDashbaordController', ['$scope', '$http', 'loggedIn', 'rootUrl', '$location', 'GetContext', '$state', '$stateParams', '$sce', '$rootScope', function ($scope, $http, loggedIn, rootUrl, $location, GetContext, $state, $stateParams, $sce, $rootScope) {
  ...
  $scope.getPageInfo = function () {
    ...
    pageInfoPromise = $http({
      url: rootUrl + '/GetPageInfo?pageID=45&parameter=',
      method: 'GET',
