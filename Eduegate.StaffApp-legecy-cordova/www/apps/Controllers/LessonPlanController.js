app.controller('LessonPlanController', ['$scope', '$http', '$state', 'rootUrl', '$location', '$rootScope', '$stateParams', 'GetContext', '$sce', function ($scope, $http, $state, rootUrl, $location, $rootScope, $stateParams, GetContext, $sce) {
  console.log('LessonPlanController loaded.');
  $scope.PageName = "Lesson Plan";
  ...
  $scope.init = function () {
    $http({
      method: 'GET',
      url: dataService + '/GetMyLessonPlans',
      data: $scope.user,
      headers: {
