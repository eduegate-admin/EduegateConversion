app.controller('AttendanceStudentDetailController', ['$scope', '$http', '$state', 'rootUrl', '$location', '$rootScope', '$stateParams', 'GetContext', '$sce', function ($scope, $http, $state, rootUrl, $location, $rootScope, $stateParams, GetContext, $sce) {
    console.log('AttendanceStudentDetailController loaded.');
        $scope.PageName = "Student Attendance Detail for " + $stateParams.studentName;
